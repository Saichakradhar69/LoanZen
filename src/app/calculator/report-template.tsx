...
export default function ReportTemplate({ reportData }: ReportTemplateProps) {
    const { scenarios, userEmail, generatedAt, loanName, couponCode } = reportData;
    ...
    return (
    <div className="bg-white text-gray-800 font-sans p-10" style={{width: '800px'}}>
      {/* Page 1: Cover */}
      ...
      <div className="h-full flex flex-col pt-16">
       ...
       {scenarios.map(scenario => (
         <div key={scenario.scenarioName} className="h-full flex flex-col pt-16">
      ...
      <div className="h-full flex flex-col pt-16">
        <h2 className="text-3xl font-bold text-blue-900 border-b-2 border-blue-800 pb-2 mb-8">
            Understanding Your Loan & Next Steps
        </h2>
        <h3 className="text-xl font-semibold mb-4">How to Use This Information</h3>
        <ul className="list-disc list-inside space-y-2 mb-8">
            <li>Use this report to negotiate with your lender.</li>
            <li>Consider the monthly payment impact on your budget.</li>
            <li>Remember to account for any upfront fees not included in this analysis.</li>
        </ul>
         <div className="border-t pt-8 text-center">
            <h3 className="text-2xl font-semibold mb-4">Track Your Loan and Maximize Savings</h3>
            <p className="max-w-2xl mx-auto mb-6">
                Your loan journey doesn't end at signing. Use your exclusive code below to try LoanZen Tracker Pro free for 14 days. Add your real loan details to get reminders before payments are due, see the impact of making extra payments, and track your progress to becoming debt-free.
            </p>
             <div className="bg-gray-100 border-dashed border-2 border-gray-400 p-4 rounded-lg inline-block">
                <p className="text-3xl font-mono tracking-widest">{couponCode}</p>
             </div>
         </div>
      </div>
    </div>
